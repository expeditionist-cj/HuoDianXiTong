<template>
  <div class="menu_setting_box js_menuBox dn"
    ...
    <div class="highlight_box icon_wrap border menu_setting_msg js_menustatus dn"
      ...
      <p class="desc"><span class="js_waitHour"></span>小时后可在手机查看菜单内容。若停用菜单，请<a
        href="/cgi-bin/plugindetails?t=service/profile&amp;pluginid=10007&amp;action=intro&amp;token=1849635325&amp;lang=zh_CN"
        class="js_closeMenu">点击这里</a></p>
    </div>
    ...
    <div class="highlight_box icon_wrap border menu_setting_msg js_menustatus dn"
      ...
      <p class="desc"><span class="js_waitHour"></span>小时后可在手机查看菜单内容。当前生效的个性化菜单内容请调用API查看。若停用菜单，请<a
        href="/cgi-bin/plugindetails?t=service/profile&amp;pluginid=10007&amp;action=intro&amp;token=1849635325&amp;lang=zh_CN"
        class="js_closeMenu">点击这里</a></p>
    </div>
    <div class="highlight_box icon_wrap border menu_setting_msg js_menustatus dn"
    ...
    <div class="page_msg mini plugin_update_tips js_authorized"
      ...
      <div class="inner group">
        ...
        <div class="msg_content">
          <p>你已授权给<span class="js_auth_name"></span>帮助你运营公众号，点击管理<a
                  ...
                  <ul class="sub_pre_menu_list">
                    <li v-for="(sub,index) in btn.sub_button"
                        ...
                        class='jslevel2'><a href="javascript:void(0);"
                                            ...
                                            class="jsSubView"
                                            draggable="false"><span class="sub_pre_menu_inner js_sub_pre_menu_inner"><i
                      class="icon20_common sort_gray"></i><span class='js_l2Title'>{{ sub.name }}</span></span></a></li>
              ...
              <div class="frm_control_group"
                ...
                <div class="frm_controls frm_vertical_pt">
                  <label class="frm_radio_label js_radio_sendMsg"
                         ...
                         data-editing="0"> <i class="icon_radio"></i> <span class="lbl_content">发送消息</span> <input
                    type="radio"
                    name="hello"
                  ...
                  <label class="frm_radio_label js_radio_url"
                         ...
                         data-editing="0"> <i class="icon_radio"></i> <span class="lbl_content">跳转网页</span> <input
                    type="radio"
                    name="hello"
                    class="frm_radio"/> </label>
                  <label class="frm_radio_label js_radio_url"
                         ...
                         data-editing="0"> <i class="icon_radio"></i> <span class="lbl_content">小程序</span> <input
                    type="radio"
                    name="hello"
                    class="frm_radio"/> </label>
                </div>
                        ...
                        <div class="tab_navs_wrp"
                          ...
                          <ul class="tab_navs js_tab_navs"
                            ...
                            <li class="tab_nav tab_appmsg width4"
                              ...
                              class="icon_msg_sender"></i><span class="msg_tab_title">图文消息</span></a></li>
                            <li class="tab_nav tab_img width4"
                              ...
                              class="icon_msg_sender"></i><span class="msg_tab_title">图片</span></a></li>
                            <li class="tab_nav tab_audio width4"
                              ...
                              class="icon_msg_sender"></i><span class="msg_tab_title">语音</span></a></li>
                            <li class="tab_nav tab_video width4 no_extra"
                                ...
                                data-tooltip="视频">
                              <a href="javascript:void(0);"
                                 @click="content_msg_tab_nav(4)">&nbsp;<i class="icon_msg_sender"></i><span
                            ...
                            <div class="tab_cont_cover jsMsgSendTab"
                              ...
                              <div class="media_cover">
                                <span class="create_access"> <a class="add_gray_wrp"
                                  ...
                                  class="icon36_common add_gray"></i>
                  ...
                  <form action=""
                    ...
                    <div class="frm_control_group">
                      ...
                      <div class="frm_controls">
                        ...
                        <p class="frm_tips"
                           id="js_urlTitle"
                           style="display: none;"> 来自<span class="js_name"></span><span style="display:none;"> -《<span
