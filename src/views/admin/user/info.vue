    ...
    data() {
      ...
      return {
        ...
        rules2: {
          ...
          newpassword1: [{required: true, min: 6, message: '密码不能为空且不少于6', trigger: 'change'}],
          newpassword2: [{required: true, min: 6, message: '密码不能为空且不少于6', trigger: 'change'},{validator: validatePass, trigger: 'blur'}]
        }
      }
    },
    created() {
