      ...
      <div class="edit-box">
        ...
        <div class="edit-content-box">
          <div class="row">
            ...
            <Box class="item" title="吸收剂耗用计划" style="width: 35%">
              <div slot="content">
          ...
          <div class="row row2">
            ...
            <Box class="item" title="耗水计划" style="width: 35%">
              <div slot="content">
                <div class="box" style="width: 100%">
                  <div class="tilte-box">
                    <span>耗水率</span>
                  ...
                  <el-input
                    ...
                    v-model.number="rowData.water_rate"
                    size="small"
                  ></el-input>
                </div>
                <div class="box" style="width: 100%">
...
import MyUpload from "@/components/myUpload/myUploadYear.vue";
...
export default {
  ...
  created() {
    this.hdTsIndicator_add = this.permissions["hdTsIndicator_add"]; // 新增
    this.hdTsIndicator_export = this.permissions["hdTsIndicator_export"]; // 下载
    this.hdTsIndicator_import = this.permissions["hdTsIndicator_import"]; // 导入
  ...
  methods: {
    ...
    onExport() {
      ...
      excel("/datamonitor/hdtsindicatoryear/export", {
        ...this.query,
        plantName: plant,
      }).then((res) => {
        let data = res.data;
        this.area_plant = area ? (plant ? area + "/" + plant : area) : "";
        let excelName = `${this.year}年 ${this.area_plant} 脱硫计划指标.xlsx`;
    ...
    changePlantPower(data) {
      this.rowData["xsj"] = data * this.rowData["xsj_rate"];
      ...
      this.rowData["water"] = data * this.rowData["water_rate"];
    ...
    changeXsj_rate(data) {
      // 【吸收剂耗用量】=【计划发电量】*【吸收剂耗用率】；
      this.rowData["xsj"] = Number(
        (data * this.rowData["plan_power"]).toFixed(4)
      );
    },
    // 改变装置耗电率
    change_hd_rate(data) {
    ...
    change_water_rate(data) {
      this.rowData["water"] = Number(data * this.rowData["plan_power"]);
    },
    // 导入excel
    submitUpload(formData) {
      this.submitLoading = true;
      upload_de_plan(formData)
        .then((res) => {
