...
export default {
  ...
  methods: {
    ...
    onExport() {
      ...
      // }
      excel("/datamonitor/hddustplanningindicators/listByMapDownload", {
        ...this.query,
        plantName: plant,
      }).then((res) => {
        let data = res.data;
        this.area_plant = area ? (plant ? area + "/" + plant : area) : "";
        let excelName = `${this.year}年 ${this.month}月 ${this.area_plant} 除尘计划指标.xlsx`;
    ...
    onOK() {
      ...
      this.rowData.month = this.query.month;
