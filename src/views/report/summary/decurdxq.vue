<template>
  <div class="zcurd">
    <el-table
      :data="tl_xq_tableData"
      style="width: 100%; min-height: 550px"
      size="small"
      :height="height"
    >
      <el-table-column label="时间" align="center" width="100" fixed>
        <template slot-scope="scope">
          <div>
            {{
              scope.row.date == "sum"
                ? "合计或平均"
                : Number(scope.row.date.slice(5)) + "月份"
            }}
          </div>
        </template>
      </el-table-column>

      <el-table-column label="装机" align="center" width="92" >
        <el-table-column
          label="MW"
          align="center"
          width="92"
      ...
      >
        <el-table-column
          v-for="(item, index) of tlUnitList"
          :key="index"
          :label="item"
          align="center"
          width="100"
      ...
      <el-table-column label="供热量" align="center" width="100">
        <el-table-column label="万吉焦" align="center" width="100" prop="heatCapacity"></el-table-column>
      </el-table-column>
      <el-table-column label="折算发电量" align="center" width="100">
        <el-table-column label="万KWh" align="center" width="100" prop="zsGenPower"></el-table-column>
      </el-table-column>
      <el-table-column label="加供热发电量" align="center" width="100" >
        <el-table-column
          label="万KWh"
          align="center"
          width="100"
      ...
      <el-table-column label="负荷率(%)" align="center" width="100">
        <el-table-column
          v-for="(item,index) of tlUnitList"
          :key="index"
          :label="item"
          ...
          :prop="'fhl'+item"
        ></el-table-column>
        <el-table-column label="合计" align="center" width="100" prop="sumFhl"></el-table-column>
      </el-table-column>

      <el-table-column label="利用小时" align="center" width="90" >
        <el-table-column
          label="h"
          align="center"
          width="90"
      ...
      >
        <template slot-scope="scope">
          <div
            v-if="scope.row.date == 'sum' || hasNoTLData(scope.row) <= 0"
          ></div>
          <div v-else>
            <el-button
              @click="onTLEdit(scope.row)"
              v-if="hdmonthreportmanualdata_update"
              type="text"
              size="small"
              >修改</el-button
...
export default {
  ...
  created() {
    ...
    // console.log(this.hdmonthreportmanualdata_update)
  },

  methods: {
    onTLEdit(row) {
      this.$emit("onTLEdit", row);
    },
  },
};
</script>
